...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@com_flare_rules_idea//idea:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.ideainfo,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@com_flare_rules_idea//idea:toolchain_type"],
...
# By default all these toolchains are registered by the idea_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:idea_toolchain",
    toolchain_type = "@com_flare_rules_idea//idea:toolchain_type",
)
""".format(
            platform = platform,
